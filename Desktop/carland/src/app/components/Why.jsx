...
const Why = () => {
  return (
    <section className="section flex items-center border-bottom-hero" id="why">
      <div className="container mx-auto">
        <motion.h2
          ...
          className="h2 text-center text-gradient"
        >
        ...
        <motion.p
          ...
          whileInView={"show"}
          viewport={{ once: false, amount: 0.6 }}
          className="max-w-[680px] text-center mx-auto mb-2 text-gradient"
        >
        ...
        >
          ...
          <div className="flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0">
            ...
            <h3 className="h3 text-gradient">Rent simply and quickly</h3>
          ...
          <div className="flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0">
            ...
            <h3 className="h3 text-gradient">Modern & well maintained vehicles</h3>
            <p className="hidden xl:flex">
              We prioritize your need and we go above and beyond to ensure your
              experience with us is nothing short of outstanding.
            </p>
          ...
          <div className="flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0">
            ...
            <h3 className="h3 text-gradient">Prompt and flexible services</h3>
            <p className="hidden xl:flex">
              We prioritize your need and we go above and beyond to ensure your
              experience with us is nothing short of outstanding.
            </p>
