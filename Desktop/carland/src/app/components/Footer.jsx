      ...
      <div className="container mx-auto mb-24">
        ...
        >
          ...
          <div className="flex-1">
            ...
            {/* form */}
            <form action="" className="flex gap-x-2 h-14 max-sm:grid max-sm:gap-4">
              <input
                type="text"
                placeholder="Your email"
                className="outline-none bg-white h-[48px] border rounded-lg pl-4 focus:border-accent max-w-[234px]"
              />
