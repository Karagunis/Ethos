          ...
          <div className="flex-1 xl:ml-24 text-center md:text-left mb-12 md:mb-0">
            <div className="max-w-[520px] mx-auto order-2 xl:order-none">
              ...
              >
                ...
                gravida egestas orci eu semper. Donec imperdiet luctus pretium.
                Sed eu tempor sem, non placerat elit. Aenean commodo metus sed
                pretium condimentum. Vestibulum ornare magna finibus, rhoncus
                dolor vel, feugiat quam. Nulla elementum sapien neque, eu
                molestie nisl facilisis id.
              </motion.p>
              <motion.div
