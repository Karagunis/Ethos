...
const About = () => {
  ...
  return (
    <section className="section flex items-center border-bottom-hero" id="about" ref={ref}>
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row xl:justify-between">
          <motion.div
            ...
            className="flex-1 mb-12 xl:mb-0"
          >
            <Image
          ...
          <div className="flex-1 flex items-center xl:justify-center">
            <div className="xl:max-w-[517px]">
              ...
              <motion.p
                ...
                whileInView={"show"}
                viewport={{ once: false, amount: 0.6 }}
                className="mb-[42px] max-w-md text-gradient"
              >
              ...
              >
                ...
                <div className="flex flex-col w-[100px]">
                  ...
                  <div className="text-3xl font-black mb-2 text-gradient">
                    {inView ? (
                      <CountUp start={0} end={50} duration={3} delay={1} />
                    ) : null}
                    +
                  </div>
                  <div className="uppercase text-[14px] font-semibold text-secondary">
                    car <br /> types
                  </div>
                </div>
                ...
                <motion.button
                  ...
                  whileInView={"show"}
                  viewport={{ once: false, amount: 0.6 }}
                  className="hidden xl:block bg-accent hover:bg-accent-hover rounded-[8px] w-full h-16 uppercase font-medium text-white tracking-[2px] text-[14px] max-w-[184px]"
                >
                  See all cars
                </motion.button>
              </motion.div>
