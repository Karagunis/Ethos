...
const recommendationData = [
  {
    ...
    desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vitae hendrerit nisl. Mauris ut nulla vitae eros ultricies aliquam. Mauris condimentum tincidunt neque ut pharetra.",
    price: 40,
    testimonial: {
      message:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vitae hendrerit nisl.",
  ...
  return (
    ...
    >
      ...
      >
        <Swiper
          modules={[Autoplay]}
          autoplay={{ delay: 400, disableOnInteraction: true }}
          loop
          speed={2000}
        >
                ...
                <div className="flex flex-col xl:flex-row xl:pl-[135px] gap-y-12 xl:gap-y-0">
                  ...
                  <div className="max-w-[345px] xl:pt-8 order-2 xl:order-1 text-center mx-auto xl:text-left xl:mx-0">
                    ...
                    <div className="flex items-center gap-x-[51px]">
                      <Button variant="accent" className="px-[42px]">
                        Book Now
                      </Button>
                  ...
                  <div className="order-1 xl:order-2 flex-1 flex justify-center xl:justify-end relative h-[634px]">
                    <div>
                      <Image
                        ...
                        quality={100}
                        alt=""
                        className="xl:rounded-tl-[21px] xl:rounded-bl-[21px]"
                      />
      ...
      {/* pattern */}
      <Image src={'/recommendation/pattern.svg'} width={240} height={240} alt="" className="hidden xl:flex absolute left-[135px] -bottom-[120px]"/>
    </motion.section>
  );
};
