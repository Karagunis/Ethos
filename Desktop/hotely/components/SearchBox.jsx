...
const SearchBox = () => {
  return (
    <motion.div
      ...
      className="w-full max-w-[488px] shadow-xl bg-white max-h-max flex flex-col border border-outline rounded-[21px] p-10"
    >
      ...
      <div className="mb-[21px]">
        ...
        {/* input & icon */}
        <div className="relative flex items-center mb-[21px]">
