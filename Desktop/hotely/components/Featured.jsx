...
const Featured = () => {
  return (
    ...
    >
      <div className="flex flex-col xl:flex-row items-center h-full gap-x-[33px] text-center xl:text-left">
        <Image
          className="xl:mr-[51px]"
        ...
        <p className="flex-1 text-soft_green leading-loose">
          ...
          vitae hendrerit nisl. Mauris ut nulla vitae eros ultricies aliquam.
          Mauris condimentum tincidunt neque ut pharetra.
        </p>
      </div>
    </motion.section>
  );
